...
\hypersetup{
  ...
  pdfauthor={Luis Alberto Calao, Jesús Moreno León, Heidy Ester Correa, Gregorio Robles},
...
\author{Luis Alberto Calao, Jesús Moreno León, Heidy Ester Correa, Gregorio Robles}
...
{\tiny
(cc) 2015 Gregorio Robles and Jesús Moreno León\\
...
\begin{columns}[T]
  \begin{column}{1\textwidth}
	 ...
	 \item Developed in the 1960s
         \item Educational use intensively investigated in the 70s and 80s
         \item Improvements in maths (and other disciplines)
       \end{itemize}
    \end{block}
  \end{column}
\end{columns}
